function ASSEMBLY = assembly_stokes_els_in_cone_iso_face_nodes_std...
    (ASSEMBLY,SF,D,B,EL2DOF,VAR,MESH,PHYSICS,NUMSCALE,OPTS)

%==========================================================================
% MODEL PARAMETERS
%==========================================================================
GCOORD          = [MESH.GCOORD MESH.GCOORD_face_nodes]; % add mid-face coordinates of the isoparametric elements
...
for i = 1:size(els_in_cone_iso,2)
    ...
    % The Jacobian for elements with curved edges needs to be computed at each integration point (quasi-cubic 14-node element to calculate the Jacobian)
    GCOORD_this_el         = GCOORD(:,EL2NOD14(:,i));
    ...
    for ip=1:OPTS.nip
        ...
        %===========================================================================================================================================================
        ECOORD  = GCOORD_SPH_rot_this_el; % element 14 nodes coordinates
        J_SL    = dNUds14{ip}'*ECOORD';   % Jacobian to transform spherical into local derivatives
...
%                 Fg_el = PHYSICS.g * NUMSCALE.Bscale * (Dens_iel-NUMSCALE.Dens0);
        ...
        %===========================================================================================================================================================
        TH_gp = sum(ECOORD.*repmat(NU14{ip},1,3)',2); % global coordinates (theta,phi,r) of the ip-th integration point
...
end % END OF FUNCTION assembly_stokes_els_in_cone_iso_face_nodes_std