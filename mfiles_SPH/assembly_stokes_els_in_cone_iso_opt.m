function ASSEMBLY = assembly_stokes_els_in_cone_iso_opt...
...
for ib=1:nblk % loop over element blocks
    ...
    for ip=1:OPTS.nip
        ...
        %======================================================================================================================
        Jth_SL    = ECOORD_th'*dNUds{ip};
        Jph_SL    = ECOORD_ph'*dNUds{ip};
        Jr_SL     = ECOORD_r' *dNUds{ip};
        ...
        %======================================================================================================================
        th_ip    = ECOORD_th'*NU{ip};
        ph_ip    = ECOORD_ph'*NU{ip};
        r_ip     = ECOORD_r' *NU{ip};
        if any(th_ip == 0)
...
end % END OF FUNCTION assembly_stokes_els_in_cone_iso_opt