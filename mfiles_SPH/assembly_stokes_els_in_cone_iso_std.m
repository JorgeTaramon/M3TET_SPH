function ASSEMBLY = assembly_stokes_els_in_cone_iso_std...
...
for i = 1:size(els_in_cone_iso,2)
    ...
    for ip=1:OPTS.nip
        ...
        %===========================================================================================================================================================
        ECOORD  = GCOORD_SPH_rot_this_el; % element 10 nodes coordinates
        J_SL    = dNUds{ip}'*ECOORD';     % Jacobian to transform spherical into local derivatives
...
%                 Fg_el = PHYSICS.g * NUMSCALE.Bscale * (Dens_iel-NUMSCALE.Dens0);
        ...
        %===========================================================================================================================================================
        TH_gp = sum(ECOORD.*repmat(NU{ip},1,3)',2); % global coordinates (theta,phi,r) of the ip-th integration point
...
end % END OF FUNCTION assembly_stokes_els_in_cone_iso_std